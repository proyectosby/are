...
<div class="tab-content" id="myTabContent">
  ...
  <div class="tab-pane fade" id="hobbies" role="tabpanel" aria-labelledby="hobbies-tab">
   ...
   <div class="tab-pane fade" id="formaciones" role="tabpanel" aria-labelledby="formaciones-tab">
	<br>
	<?php //$modelp = new PersonasFormaciones();?>
		<!--<?=$html=$this->render('personas-formaciones/index', array(
			'model' => $this->load($modelp, 'PersonasFormaciones'),
			),true);?>-->
  </div>
</div>
